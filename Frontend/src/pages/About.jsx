...
export default function About() {
  const team = [
    { name: "Mudasir Hussain", role: "Founder & Lead Dev", avatar: "https://i.pravatar.cc/120?img=10", color: "#8880d8" },
    { name: "Ali Khan",        role: "Backend Engineer",    avatar: "https://i.pravatar.cc/120?img=1",  color: "#5878a0" },
    { name: "Sara Ahmed",      role: "UI/UX Designer",      avatar: "https://i.pravatar.cc/120?img=5",  color: "#4a8870" },
    { name: "Usman Tariq",     role: "DevOps & Infra",      avatar: "https://i.pravatar.cc/120?img=3",  color: "#a07040" },
  ];
            ...
            {team.map(({ name, role, avatar, color }, i) => (
              <div key={i} className="team-card">
                <div className="team-avatar-wrap">
                  ...
                  <div className="team-avatar-ring" style={{ borderColor: color }} />
                </div>
                <h3 className="team-name">{name}</h3>
                <p className="team-role" style={{ color }}>{role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="about-cta">
        ...
        <div className="about-cta-content">
          <div className="about-cta-text">
            ...
            <p className="about-cta-sub">Thousands of communities are already here. Find yours today.</p>
          </div>
          <div className="about-cta-actions">
            ...
            <NavLink to="/" className="about-btn-ghost">Back to Home</NavLink>
          </div>
        </div>
      </section>
    </>
